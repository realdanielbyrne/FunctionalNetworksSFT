...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('experiments/experiment_a_peft_only/output/experiment_a.log'),
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("\n❌ Experiment A failed!")
        print("📋 Check experiments/experiment_a_peft_only/output/experiment_a.log for details")
        sys.exit(1)
